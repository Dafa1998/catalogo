...
<div class="contenedor">
    ...
    <form action="?url=categoria&action=add" method="post" class="form" enctype="multipart/form-data">
    <div class="datos">
        <input type="text" name="categoria" class="usuario" placeholder="Nombre Categoria">
    </div>
    ...
    <div class="datos2">
        <input type="submit" value="Agregar Categoria"class="btn">
    </div>
    <ul>
